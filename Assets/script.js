...
//Build Previous Searched Cities List
...
//Populate the Current Weather for Selected City
function getWeather(cityName, latData, longData) {
  ...
  $.ajax({
    ...
    document.getElementById("cityNameLabel").innerHTML =
      cityName +
      "(" +
      current_date +
      ")" +
    ...
    for (var i = 0; i < 6; i++) {
      ...
      //Creating the 5 Day Forecast Boxes
      var newBox = $("<div>");
      var newCol = $("<col>");
      var newDate = $("<div>");
      newDate.text(time);
